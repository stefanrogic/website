  ...
  return (
    <div className="about" id="about">
      ...
      <p>
        ...
        eos, cumque tenetur rerum vel magnam quam. Enim aliquid aliquam culpa hic at beatae numquam fugiat non totam sed cum minima sunt, tempora consequatur tempore quae tenetur corrupti quam dicta voluptates ex a exercitationem consequuntur quasi.
        Iusto, quisquam a! Expedita in tempore dolore error ratione minus earum doloribus deserunt temporibus perspiciatis similique dolorum deleniti.
      </p>
    </div>
  );
};
