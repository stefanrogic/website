    ...
    >
      ...
      >
        <motion.path
          ...
          strokeWidth="1"
          strokeLinecap="round"
          variants={{ hidden: { pathLength: 0, opacity: 0 }, draw: { opacity: 1, pathLength: 1, transition: { opacity: { duration: 0 }, pathLength: { duration: 0.5, ease: "easeInOut" } } } }}
          initial="hidden"
        ...
        <motion.path
          ...
          strokeWidth="1"
          strokeLinecap="round"
          variants={{ hidden: { pathLength: 0, opacity: 0 }, draw: { opacity: 1, pathLength: 1, transition: { opacity: { duration: 0, delay: 0.5 }, pathLength: { duration: 0.5, delay: 0.5, ease: "easeInOut" } } } }}
          initial="hidden"
          animate={lineControls}
        />
        <motion.path
          ...
          strokeWidth="1"
          strokeLinecap="round"
          variants={{ hidden: { pathLength: 0, opacity: 0 }, draw: { opacity: 1, pathLength: 1, transition: { opacity: { duration: 0, delay: 1 }, pathLength: { duration: 0.5, delay: 1, ease: "easeInOut" } } } }}
          initial="hidden"
          animate={lineControls}
        />
        <motion.path
          ...
          strokeWidth="1"
          strokeLinecap="round"
          variants={{ hidden: { pathLength: 0, opacity: 0 }, draw: { opacity: 1, pathLength: 1, transition: { opacity: { duration: 0, delay: 1.5 }, pathLength: { duration: 0.5, delay: 1.5, ease: "easeInOut" } } } }}
          initial="hidden"
          animate={lineControls}
        />
        <motion.path
          ...
          strokeWidth="1"
          strokeLinecap="round"
          variants={{ hidden: { pathLength: 0, opacity: 0 }, draw: { opacity: 1, pathLength: 1, transition: { opacity: { duration: 0, delay: 2 }, pathLength: { duration: 0.5, delay: 2, ease: "easeInOut" } } } }}
          initial="hidden"
          animate={lineControls}
        />
        ...
        <motion.path
          ...
          strokeWidth="1"
          strokeLinecap="round"
          variants={{ hidden: { pathLength: 0, opacity: 0 }, draw: { opacity: 1, pathLength: 1, transition: { opacity: { duration: 0, delay: 2.5 }, pathLength: { duration: 0.5, delay: 2.5, ease: "easeInOut" } } } }}
          initial="hidden"
          animate={lineControls}
        />
        <motion.path
          ...
          strokeWidth="1"
          strokeLinecap="round"
          variants={{ hidden: { pathLength: 0, opacity: 0 }, draw: { opacity: 1, pathLength: 1, transition: { opacity: { duration: 0, delay: 3 }, pathLength: { duration: 0.5, delay: 3, ease: "easeInOut" } } } }}
          initial="hidden"
          animate={lineControls}
        />
        <motion.path
          ...
          strokeWidth="1"
          strokeLinecap="round"
          variants={{ hidden: { pathLength: 0, opacity: 0 }, draw: { opacity: 1, pathLength: 1, transition: { opacity: { duration: 0, delay: 3.5 }, pathLength: { duration: 0.5, delay: 3.5, ease: "easeInOut" } } } }}
          initial="hidden"
          animate={lineControls}
        />
        <motion.path
          ...
          strokeWidth="1"
          strokeLinecap="round"
          variants={{ hidden: { pathLength: 0, opacity: 0 }, draw: { opacity: 1, pathLength: 1, transition: { opacity: { duration: 0, delay: 4 }, pathLength: { duration: 0.5, delay: 4, ease: "easeInOut" } } } }}
          initial="hidden"
          animate={lineControls}
        />
        <motion.path
          ...
          strokeWidth="1"
          strokeLinecap="round"
          variants={{ hidden: { pathLength: 0, opacity: 0 }, draw: { opacity: 1, pathLength: 1, transition: { opacity: { duration: 0, delay: 4.5 }, pathLength: { duration: 0.5, delay: 4.5, ease: "easeInOut" } } } }}
          initial="hidden"
          animate={lineControls}
        />
        <motion.path
          ...
          strokeWidth="1"
          strokeLinecap="round"
          variants={{ hidden: { pathLength: 0, opacity: 0 }, draw: { opacity: 1, pathLength: 1, transition: { opacity: { duration: 0, delay: 5 }, pathLength: { duration: 0.5, delay: 5, ease: "easeInOut" } } } }}
          initial="hidden"
          animate={lineControls}
        />
        <motion.path
          ...
          strokeWidth="1"
          strokeLinecap="round"
          variants={{ hidden: { pathLength: 0, opacity: 0 }, draw: { opacity: 1, pathLength: 1, transition: { opacity: { duration: 0, delay: 5.5 }, pathLength: { duration: 0.5, delay: 5.5, ease: "easeInOut" } } } }}
          initial="hidden"
          animate={lineControls}
        />
        <motion.path
          ...
          strokeWidth="1"
          strokeLinecap="round"
          variants={{ hidden: { pathLength: 0, opacity: 0 }, draw: { opacity: 1, pathLength: 1, transition: { opacity: { duration: 0, delay: 6 }, pathLength: { duration: 0.5, delay: 6, ease: "easeInOut" } } } }}
          initial="hidden"
          animate={lineControls}
        />
      </motion.svg>
